# Troubleshooting — IT-Stack TRAEFIK
...
```bash
# Test connectivity
psql -h lab-db1 -U traefik_user -d traefik_db -c '\conninfo'
...
1. Check resource usage: docker stats it-stack-traefik
...
| Log | Path |
|-----|------|
| Application | docker compose logs traefik |
