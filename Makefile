# Makefile — IT-Stack TRAEFIK (Module 18)
...
build: ## Build Docker image
	docker build -t it-stack/traefik:latest .
...
test-lab-01: ## Lab 01 — Standalone
	@bash tests/labs/test-lab-18-01.sh
...
deploy: ## Deploy to target server (lab-proxy1)
	ansible-playbook -i ansible/inventory.yml ansible/playbooks/deploy-traefik.yml
